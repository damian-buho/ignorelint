...
- Політика лінту (`fail-on`, `format`, `fix`, `disabled-rules`, `override`) живе у піддереві `org.ignorelint` файла `projectfile.yaml`, тож один файл несе ідентичність проєкту і правила. Див. [довідник CLI](docs/cli.md).
