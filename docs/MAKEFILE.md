...
Lint Crystal code with Ameba

`auto-ameba`

> Image: D9T_CRYSTAL_TOOLS_IMAGE

### `ameba-fix`

Autofix Ameba findings
...
Generate Crystal API documentation
...
Check Crystal formatting without writing
